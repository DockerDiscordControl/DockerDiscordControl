...
document.addEventListener('DOMContentLoaded', function() {
        ...
        function testMechAnimation() {
            ...
            .then(blob => {
                ...
                preview.textContent = ''; // Clear existing content
                const img = document.createElement('img');
                img.src = url;
                img.alt = 'Mech Animation';
                img.style.cssText = 'max-width: 100%; height: auto; border: 1px solid #666;';
            ...
            .then(data => {
                ...
                const mechHtml = `
                    <div class="mech-container position-relative" style="height: 100px; overflow: hidden;">
                        ...
                        ${data.effects.sparks ? '<div class="sparks">⚡⚡⚡</div>' : ''}
                    </div>
                    <div class="mt-2">
        ...
        function testSimpleMech() {
            ...
            preview.innerHTML = `
                <div style="position: relative; height: 120px; overflow: hidden; background: linear-gradient(90deg, #2f3136 0%, #36393f 50%, #2f3136 100%); border-radius: 8px;">
                    ...
                    ${speedLevel >= 6 ? '<div style="position: absolute; top: 15px; left: 50%; transform: translateX(-50%); font-size: 25px; animation: flash 0.3s ease-in-out infinite; color: #ffff00;">⚡️💫⚡️</div>' : ''}
                </div>
