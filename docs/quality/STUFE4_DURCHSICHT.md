...
37 Abschnitte, 188 Stücke, **61.101 von 61.101 Zeilen** in 183 Dateien (`docs/quality/ABSCHNITTE.txt`).
...
| | Abschnitte | Zeilen |
|---|---|---|
| enthalten eine Datei, in der etwas geändert wurde | 28 | 46.757 (76 %) |
| gar nicht berührt | **9** | **14.344 (24 %)** |

Die Rechnung offen, damit sie nachprüfbar ist statt geglaubt: Die neun unberührten Abschnitte
summieren sich gemessen auf 14.344 Zeilen; 61.101 − 14.344 = 46.757.
