...
37 Abschnitte, 190 Stücke, **61.284 von 61.284 Zeilen** in 185 Dateien (`docs/quality/ABSCHNITTE.txt`).
...
| | Abschnitte | Zeilen |
|---|---|---|
| enthalten eine Datei, in der etwas geändert wurde | 31 | 52.601 (86 %) |
| gar nicht berührt | **6** | **8.683 (14 %)** |

Die Rechnung offen, damit sie nachprüfbar ist statt geglaubt: Die sechs unberührten Abschnitte
summieren sich gemessen auf 8.683 Zeilen; 61.284 − 8.683 = 52.601.
