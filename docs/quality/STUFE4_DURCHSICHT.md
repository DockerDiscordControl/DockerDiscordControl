...
37 Abschnitte, 188 Stücke, **60.777 von 60.777 Zeilen** in 183 Dateien (`docs/quality/ABSCHNITTE.txt`).
...
| | Abschnitte | Zeilen |
|---|---|---|
| enthalten eine Datei, in der etwas geändert wurde | 28 | 46.433 (76 %) |
| gar nicht berührt | **9** | **14.344 (24 %)** |

Die Rechnung offen, damit sie nachprüfbar ist statt geglaubt: Die neun unberührten Abschnitte
summieren sich gemessen auf 14.344 Zeilen; 60.777 − 14.344 = 46.433.
