...
37 sections, 190 pieces, **61,424 of 61,424 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,286 (93 %) |
...
sections add up to 4,138 lines as measured; 61,424 − 4,138 = 57,286.
