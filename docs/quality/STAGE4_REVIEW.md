...
37 sections, 190 pieces, **61,263 of 61,263 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,125 (93 %) |
...
sections add up to 4,138 lines as measured; 61,263 − 4,138 = 57,125.
