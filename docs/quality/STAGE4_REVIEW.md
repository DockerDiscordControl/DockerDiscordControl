...
37 sections, 190 pieces, **61,408 of 61,408 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,270 (93 %) |
...
sections add up to 4,138 lines as measured; 61,408 − 4,138 = 57,270.
