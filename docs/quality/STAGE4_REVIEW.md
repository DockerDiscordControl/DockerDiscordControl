...
37 sections, 190 pieces, **61,358 of 61,358 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,220 (93 %) |
...
sections add up to 4,138 lines as measured; 61,358 − 4,138 = 57,220.
