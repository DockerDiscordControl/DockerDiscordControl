...
37 sections, 190 pieces, **61,306 of 61,306 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,168 (93 %) |
...
sections add up to 4,138 lines as measured; 61,306 − 4,138 = 57,168.
