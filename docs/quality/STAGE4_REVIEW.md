...
37 sections, 190 pieces, **61,438 of 61,438 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 35 | 58,735 (96 %) |
| not touched at all | **2** | **2,703 (4 %)** |

The calculation in the open, so that it can be checked instead of believed: the two untouched
sections add up to 2,703 lines as measured; 61,438 − 2,703 = 58,735.
