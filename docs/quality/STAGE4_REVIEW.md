...
37 sections, 190 pieces, **61,374 of 61,374 lines** in 185 files (`docs/quality/SECTIONS.txt`).
...
| | Sections | Lines |
|---|---|---|
| contain a file in which something was changed | 34 | 57,236 (93 %) |
...
sections add up to 4,138 lines as measured; 61,374 − 4,138 = 57,236.
