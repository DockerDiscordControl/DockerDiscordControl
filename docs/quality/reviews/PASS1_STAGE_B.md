...
| 04 | F3 | low / unsure | open | _setup_background_loops wraps every other startup task (status_task, edit_task, inactivity_task, cache_task, and heartbeat_task when enabled) with `se |
